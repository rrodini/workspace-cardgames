...
/**
  ...
  */
	public ArrayList<Card> deal(int count) {
	  ...
	  * @throws IllegalStateException when deck doesn't contain enough cards for deal.
	  */
		public ArrayList<Card> deal(int count, DealPosition pos) {
			Card [] d = new Card[count];
  ...
  */
	public ArrayList<Card> removeCard(List<Card> cardsToRemove) {
  ...
  */
	public void addCards(ArrayList<Card> list, AddToDeck how) {
		if (how == ADD_TO_TOP) {
			cards.addAll(0, list);
