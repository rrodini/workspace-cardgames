...
class TestThreeOfAKind {
	...
	void playTheseCards(List<Card> startCards, List<Card> expected, boolean expectedResult) {
		...
		ThreeOfAKindPlayer player = new ThreeOfAKindPlayer(startHand);
	...
	@Test
	@DisplayName("Naturals: 2:C,8:D,9:H Jokers: J1,J2")
	void testLogic1() {
	...
	@Test
	@DisplayName("Naturals: 2:C,8:D,8:H,9:C Jokers: J1")
	void testLogic2() {
		List<Card> startCards = Arrays.asList(
				new Card(Suit.CLUB,    2),
				new Card(Suit.DIAMOND, 8),
	...
	@Test
	@DisplayName("Naturals: 2:C,2:D,8:H,9:C Jokers: J1")
	void testLogic3() {
		List<Card> startCards = Arrays.asList(
				new Card(Suit.CLUB,    2),
				new Card(Suit.DIAMOND, 2),
				new Card(Suit.HEART,   8),
				new Card(Suit.CLUB,    9), // Joker 2
				new Card(null, Integer.MAX_VALUE));  // Joker 1
		List<Card> expected = Arrays.asList(
				new Card(Suit.CLUB,    2),
				new Card(Suit.DIAMOND, 2),
	...
	@Test
	@DisplayName("Naturals: 2:C,8:D,9:H,9:C Jokers: J1")
	void testLogic4() {
		List<Card> startCards = Arrays.asList(
				new Card(Suit.CLUB,    2),
				new Card(Suit.DIAMOND, 8),
